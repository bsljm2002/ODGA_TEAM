...
import com.jongmyeong.odga.App.NOTIFICATON_CHANNEL_ID
import com.jongmyeong.odga.databinding.ActivitySoundDetectBinding
...
class SoundDetect : AppCompatActivity(), PermissionListener {
    ...
    private var mActivityMainBinding: ActivitySoundDetectBinding? = null
    ...
    override fun onPermissionGranted() {
         ...
         */
        mActivityMainBinding = DataBindingUtil.setContentView(this, R.layout.activity_sound_detect)
        mActivityMainBinding?.run { soundDetect = soundDetect }     // 오류나면 확인해봐야될 곳(with, run)
        if (loadLabels()) {
            /*
                ...
                when (msg.arg1) {
                    3, 9 -> {
                        ...
                        val objectAnimator: ObjectAnimator = ObjectAnimator.ofFloat<View?>(
                            mActivityMainBinding?.appCompatImageViewWarning,
                            View.ALPHA,
                            1.0f,
                            0.0f
                        )
                        ...
                        val objectAnimator1: ObjectAnimator = ObjectAnimator.ofFloat<View?>(
                            mActivityMainBinding?.appCompatImageViewflash,
                            View.ALPHA,
                            0.15f,
                            0.0f
                        )
    ...
    private fun showNotification() {
        ...
        val builder: NotificationCompat.Builder = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            NotificationCompat.Builder(this@SoundDetect, NOTIFICATON_CHANNEL_ID.toString())
             ...
             */
            NotificationCompat.Builder(this@SoundDetect)
                .setSmallIcon(R.drawable.sharp_notification_important_24) // 아이콘
                .setContentIntent(
    ...
    /*
        ...
        3. 스스로는 다시 1번으로 돌아가 청취를 재시작하는 과정을 거친다.
